...
@ManagedBean
@ViewScoped
public class GGIBean implements Serializable {
	private List<Aluno> alunosGGI;
	private List<Responsavel> responsaveis;
	private List<Grupo> grupos;
	private List<Aluno> meninas;
	private List<Aluno> meninos;
	private Responsavel responsavel;
	private int quantidadeGGI;
	private int quantidadeMeninos;
	private int quantidadeMeninas;

	public List<Aluno> getAlunosGGI() {
		return alunosGGI;
	}

	public void setAlunosGGI(List<Aluno> alunosGGI) {
		this.alunosGGI = alunosGGI;
	}
	...
	public int getQuantidadeGGI() {
		return quantidadeGGI;
	}

	public void setQuantidadeGGI(int quantidadeGGI) {
		this.quantidadeGGI = quantidadeGGI;
	}
	...
	public void listarGGI() {
		try {
			...
			alunosGGI = alunoDAO.buscarPorGrupo(2L);
			meninas = alunoDAO.buscarPorSexo(Sexo.F, 2L);
			meninos = alunoDAO.buscarPorSexo(Sexo.M, 2L);
			
			for (Aluno aluno : alunosGGI) {
