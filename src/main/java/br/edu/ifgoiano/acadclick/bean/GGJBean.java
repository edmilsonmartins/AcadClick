...
@ManagedBean
@ViewScoped
public class GGJBean implements Serializable {
	private List<Aluno> alunosGGJ;
	private List<Responsavel> responsaveis;
	private List<Grupo> grupos;
	private List<Aluno> meninas;
	private List<Aluno> meninos;
	private Responsavel responsavel;
	private int quantidadeGGJ;
	private int quantidadeMeninos;
	private int quantidadeMeninas;

	public List<Aluno> getAlunosGGJ() {
		return alunosGGJ;
	}

	public void setAlunosGGJ(List<Aluno> alunosGGJ) {
		this.alunosGGJ = alunosGGJ;
	}
	...
	public int getQuantidadeGGJ() {
		return quantidadeGGJ;
	}

	public void setQuantidadeGGJ(int quantidadeGGJ) {
		this.quantidadeGGJ = quantidadeGGJ;
	}
	...
	public void listarGGI() {
		try {
			...
			alunosGGJ = alunoDAO.buscarPorGrupo(3L);
			meninas = alunoDAO.buscarPorSexo(Sexo.F, 3L);
			meninos = alunoDAO.buscarPorSexo(Sexo.M, 3L);
			
			for (Aluno aluno : alunosGGJ) {
